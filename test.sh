...
schema="@public collection User { id: string; name: string; constructor (name: string) { this.id = name; this.name = name; } } @public collection Account { id: string; user: User; constructor (id: string, user: User) { this.id = id; this.user = user; } noop() {} }"
...
http GET :8080/v0/collections/ns18830%2FAccount/records where=='{"id": "johnacc"}'

# TODO: fix No index found matching the query
http GET :8080/v0/collections/ns18830%2FAccount/records where=='{"user.id": "john"}'
