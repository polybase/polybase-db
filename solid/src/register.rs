...
/**
 * ProposalRegister is responsible creating an event stream of ProposalEvent events, and
...
impl ProposalRegister {
    ...
    pub fn receive_accept(&mut self, accept: &ProposalAccept, from: &PeerId) {
